...
<html>
  <head>
    <title>Camilo Castelo Branco</title>
    <meta charset="utf-8">
  ...
  <fieldset>
    <div class="gallery">
      <a target="_blank" href="../livros/AmorEPerdicao.pdf">
        <img src="../img/amor-de-perdicao.png" alt="Amor de Perdição" width="800" height="500">
        <div class="desc"><strong> Amor de Perdição</strong></div>
      </a>
    </div>
  </fieldset>
</body>
